export interface PickrConfig {
  ...
  components?: {
    ...
    preview?: boolean, // Left side color comparison
    opacity?: boolean, // Opacity slider
    hue?: boolean,     // Hue slider

    // Bottom interaction bar, theoretically you could use 'true' as propery.
    // But this would also hide the save-button.
    interaction?: {
      hex?: boolean,  // hex option  (hexadecimal representation of the rgba value)
      rgba?: boolean, // rgba option (red green blue and alpha)
      hsla?: boolean, // hsla option (hue saturation lightness and alpha)
      hsva?: boolean, // hsva option (hue saturation value and alpha)
      cmyk?: boolean, // cmyk option (cyan mangenta yellow key )

      input?: boolean, // input / output element
      clear?: boolean, // Clear button
      save?: boolean   // Save button
    },
  },
